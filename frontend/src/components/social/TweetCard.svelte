<script lang="ts">
  ...
  function handleLike() {
    ...
    isLiked = !isLiked; // Toggle state locally
  }
  ...
  function handleBookmark() {
    ...
    isBookmarked = !isBookmarked; // Toggle state locally
  }
    ...
    <div class="flex items-start">
      ...
      <div class="flex-1 min-w-0">
        ...
        <div class="flex justify-between mt-3 {isDarkMode ? 'text-gray-400' : 'text-gray-500'}">
          ...
          <div class="flex items-center">
            <button 
              class="tweet-action-btn flex items-center {isDarkMode ? 'bg-black hover:bg-green-500/10' : 'hover:bg-green-100'} {isReposted ? 'text-green-500' : ''} hover:text-green-500 rounded-full p-2 transition-all" 
          ...
          <div class="flex items-center">
            <button 
              class="tweet-action-btn flex items-center {isDarkMode ? 'bg-black hover:bg-red-500/10' : 'hover:bg-red-100'} {isLiked ? 'text-red-500' : ''} hover:text-red-500 rounded-full p-2 transition-all" 
          ...
          <div class="flex items-center">
            <button 
              class="tweet-action-btn flex items-center {isDarkMode ? 'bg-black hover:bg-blue-500/10' : 'hover:bg-blue-100'} {isBookmarked ? 'text-blue-500' : ''} hover:text-blue-500 rounded-full p-2 transition-all" 

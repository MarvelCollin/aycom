<script lang="ts">
  ...
  const { tweets, toggleBookmark, likeTweet, repostTweet, trends, suggestedUsers } = useSocialMedia();
...
<div class="min-h-screen {isDarkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'} transition-colors duration-300">

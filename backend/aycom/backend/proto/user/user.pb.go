...
type GetAllUsersRequest struct {
	...
	NewsletterOnly bool                   `protobuf:"varint,6,opt,name=newsletter_only,json=newsletterOnly,proto3" json:"newsletter_only,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *GetAllUsersRequest) GetNewsletterOnly() bool {
	if x != nil {
		return x.NewsletterOnly
	}
	return false
}
...
func (x *CommunityRequest) GetLogoUrl() string {
	if x != nil {
		return x.LogoUrl
	}
	return ""
...
func (x *CommunityRequest) GetBannerUrl() string {
	if x != nil {
		return x.BannerUrl
	}
	return ""
...
const file_proto_user_user_proto_rawDesc = "" +
	...
	"\fsearch_query\x18\x05 \x01(\tR\vsearchQuery\x12'\n" +
	"\x0fnewsletter_only\x18\x06 \x01(\bR\x0enewsletterOnly\"l\n" +
	...
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12)\n" +
	"\x10recipients_count\x18\x03 \x01(\x05R\x0frecipientsCount\"\xcc\x02\n" +
	...
	".user.UserR\trequester\x12\x19\n" +
	"\blogo_url\x18\n" +
	" \x01(\tR\alogoUrl\x12\x1d\n" +
	"\n" +
	"banner_url\x18\v \x01(\tR\tbannerUrl\"_\n" +

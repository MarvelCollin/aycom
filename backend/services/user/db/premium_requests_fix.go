...
// UpdatePremiumRequestsTable adds missing columns to the premium_requests table
func UpdatePremiumRequestsTable(db *gorm.DB) error {
	log.Println("Checking premium_requests table structure...")

	// Check if identity_card_number column exists
	...
	// Check for face_photo_url column
